...
const HomePageDashboard = () => {
  ...
  if (loading) {
    return <div className="absolute top-1/2 right-1/2" role="status">
       <span class="sr-only">Carregando...</span>
    <svg aria-hidden="true" class="w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-[#FF2193]" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</div>; // Exibe mensagem de carregamento enquanto os dados são buscados
  }
